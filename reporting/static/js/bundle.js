...
/***/ function(module, exports, __webpack_require__) {
	...
	function updateData(state) {
	  segment(state.url, state.project, state.from, state.to).done(function (data) {
	    console.log(data);
	  });
	  table(state.url, state.project, state.from, state.to).done(function (data) {
	    console.log(data);
	  });
	}
	  ...
	  var result_of_with = (function($component) {
	    ...
	    return {
	      value: (h("div", {
	        ...
	        var __jade_nodes = [];
	        __jade_nodes = __jade_nodes.concat("this is my graph");
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  return h("div", {
	    ...
	    var __jade_nodes = [];
	    __jade_nodes = __jade_nodes.concat("This is my table");;
	    return __jade_nodes
	  }).call(this).filter(Boolean))
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = (function(from, to) {
	    var h = __webpack_require__(47);
	    return {
	      value: (h("div", {
	        "className": [].concat('datepicker').filter(Boolean).join(' '),
	      }, (function() {
	        var __jade_nodes = [];
	        __jade_nodes = __jade_nodes.concat("this is my date picker");
	        __jade_nodes = __jade_nodes.concat(h("div", {
	          "className": [].concat('from').filter(Boolean).join(' '),
	        }, (function() {
	          var __jade_nodes = [];
	          __jade_nodes = __jade_nodes.concat("" + (from) + "");;
	          return __jade_nodes
	        }).call(this).filter(Boolean)));
	        __jade_nodes = __jade_nodes.concat(h("div", {
	  ...
	  }.call(this, "from" in locals ? locals.from : typeof from !== "undefined" ? from : undefined, "to" in locals ? locals.to : typeof to !== "undefined" ? to : undefined));
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
