...
/***/ function(module, exports, __webpack_require__) {
	...
	var _graph = __webpack_require__(48);
	...
	document.registerElement('project-app', function (_Component) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function updateData() {
	      ...
	      this.table().done(function (data) {
	        if (!_this2.state.table) {
	          table = $('.table').DataTable({
	            columns: [{ title: 'Name', data: 'Event' }, { title: 'Date', data: 'date' }]
	          });
	        } else {
	          var table = _this2.state.table;
	        }
	        var tableData = JSON.parse(data);
	        table.clear().draw();
	        table.rows.add(tableData).draw();
	        _this2.update({ tableData: tableData, table: table });
	      });
	    }
	  }, {
	    key: 'segment',
	    value: function segment() {
	      var args = ['/segment/?token=', this.state.project, '&from_date=', this.state.from, '&to_date=', this.state.to].join('');
	      return this.simpleAjax(this.state.url, args);
	    }
	  }, {
	    key: 'table',
	    value: function table() {
	      var args = ['/table/?token=', this.state.project, '&from_date=', this.state.from, '&to_date=', this.state.to].join('');
	      return this.simpleAjax(this.state.url, args);
	    }
	  }, {
	    key: 'simpleAjax',
	    value: function simpleAjax(url, args) {
	      return $.ajax({
	        url: url + args,
	        type: 'GET',
	        dateType: 'json',
	    ...
	    get: function get() {
	      return {
	        defaultState: {
	          ...
	          from: (0, _moment2.default)().subtract(30, 'days').format('YYYY-MM-DD'),
	          to: (0, _moment2.default)().format('YYYY-MM-DD'),
	          type: 'line',
	          graphData: [],
	          tableData: []
	        },
	...
	document.registerElement('table-view', function (_Component2) {
	  ...
	  _createClass(_class2, [{
	    key: 'attachedCallback',
	    value: function attachedCallback() {
	      _get(_class2.prototype.__proto__ || Object.getPrototypeOf(_class2.prototype), 'attachedCallback', this).call(this);
	      this.update();
	    }
	  }, {
	    key: 'config',
	...
	document.registerElement('graph-view', function (_Component3) {
	...
	document.registerElement('toggle-view', function (_Component4) {
	...
	document.registerElement('date-view', function (_Component5) {
	  ...
	  _createClass(_class5, [{
	    ...
	    value: function changeToDate() {
	      this.update({ to: (0, _moment2.default)($('.to').val()).format('YYYY-MM-DD') });
	      this.$panelRoot.updateData();
	    }
	  }, {
	    key: 'config',
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = (function($component) {
	    ...
	    return {
	      value: (h("div", {
	        "className": [].concat('project-app').filter(Boolean).join(' '),
	      }, (function() {
	        var __jade_nodes = [];
	        __jade_nodes = __jade_nodes.concat($component.child('graph-view'));
	        __jade_nodes = __jade_nodes.concat($component.child('table-view'));;
	        return __jade_nodes
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  return h("div", (function() {
	    var __jade_nodes = [];
	    __jade_nodes = __jade_nodes.concat(h("table", {
	      "className": [].concat('table').filter(Boolean).join(' '),
	    }));;
	    return __jade_nodes
	  }).call(this).filter(Boolean))
	}
	    ...
	    return {
	      value: (h("div", (function() {
	        ...
	        __jade_nodes = __jade_nodes.concat(h("input", {
	          "onchange": $helpers.fromChange,
	          "className": [].concat('from').filter(Boolean).join(' '),
	        }));
	        __jade_nodes = __jade_nodes.concat(h("input", {
	          "onchange": $helpers.toChange,
	          "className": [].concat('to').filter(Boolean).join(' '),
	        }));;
	        return __jade_nodes
	      }).call(this).filter(Boolean)))
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (global, factory) {
	    true ? factory(__webpack_require__(57)) :
